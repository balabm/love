          ...
          <div className="snt-modern-grid">
            {Object.entries(health)
              .filter(([name]) => [
                ...
                "inner_critic_tamer", "perfectionism_healer", "comparison_detoxifier", "money_mindset_coach", "scarcity_healer", "generosity_cultivator", "abundance_architect", "decision_quality_tracker", "optionality_maximizer", "expected_value_coach", "regret_minimizer",
                "discipline_trainer", "consistency_coach",
                "accountability_partner", "progress_celebrator",
                "energy_protector", "boundary_enforcer",
                "time_sovereign", "attention_guardian",
