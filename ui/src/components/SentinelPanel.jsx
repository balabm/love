          ...
          <div className="snt-modern-grid">
            {Object.entries(health)
              .filter(([name]) => [
                ...
                "inner_critic_tamer", "perfectionism_healer", "comparison_detoxifier", "money_mindset_coach", "scarcity_healer", "generosity_cultivator", "abundance_architect", "decision_quality_tracker", "optionality_maximizer", "expected_value_coach", "regret_minimizer", "cognitive_bias_detector", "mental_model_trainer", "first_principles_thinker", "systems_thinking_coach", "authentic_expression_coach", "vulnerable_communication_trainer", "difficult_conversation_navigator", "active_listening_master", "body_awareness_trainer", "breath_work_coach", "movement_intelligence", "posture_presence_coach", "intimacy_coach", "sensory_awareness_trainer", "passion_cultivator", "deep_connection_coach", "music_mood_regulator", "sound_healing_guide", "playlist_therapist", "rhythmic_living_coach", "mindful_eating_coach", "cooking_joy_cultivator", "meal_ritual_designer", "food_as_medicine_coach", "pet_bonding_coach", "animal_empathy_trainer", "pet_loss_support", "human_animal_connection_guide", "garden_therapy_coach", "plant_parenting_guide", "seasonal_garden_planner", "urban_gardening_coach", "voice_presence_coach", "stage_confidence_builder", "audience_connection_trainer", "speech_craft_coach", "photo_memory_keeper", "visual_storytelling_coach", "mindful_photography_guide", "memory_curation_coach", "home_repair_coach", "diy_project_planner", "maker_mindset_trainer", "handcraft_joy_cultivator", "style_expression_coach", "wardrobe_mindfulness_guide", "personal_brand_designer", "dress_for_joy_coach", "language_immersion_coach", "cross_cultural_bridge_builder", "conversation_fluency_trainer", "vocabulary_growth_coach", "daily_writing_coach", "publishing_navigator", "blog_craft_coach", "newsletter_creator",
                "discipline_trainer", "consistency_coach",
                "accountability_partner", "progress_celebrator",
                "energy_protector", "boundary_enforcer",
                "time_sovereign", "attention_guardian",
